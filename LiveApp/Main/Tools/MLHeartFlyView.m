...
#define MLRGBColor(r, g, b) [UIColor colorWithRed:(r)/255.0 green:(g)/255.0 blue:(b)/255.0 alpha:1]
#define MLRGBAColor(r, g, b ,a) [UIColor colorWithRed:(r)/255.0 green:(g)/255.0 blue:(b)/255.0 alpha:a]
#define MLRandColor MLRGBColor(arc4random_uniform(255), arc4random_uniform(255), arc4random_uniform(255))

#import "MLHeartFlyView.h"

@interface MLHeartFlyView ()
@property(nonatomic,strong) UIColor *strokeColor;
@property(nonatomic,strong) UIColor *fillColor;
@end


@implementation MLHeartFlyView
...
-(void)animateInView:(UIView *)view{
    NSTimeInterval totalAnimationDuration = 6;//上飘速度
